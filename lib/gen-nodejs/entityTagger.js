...
EntityTagger_createEntity_args = function(args) {
  this.entity = null;
  if (args) {
...
EntityTagger_createEntity_args.prototype = {};
EntityTagger_createEntity_args.prototype.read = function(input) {
...
EntityTagger_createEntity_args.prototype.write = function(output) {
  output.writeStructBegin('EntityTagger_createEntity_args');
...
EntityTagger_createEntity_result = function(args) {
  this.success = null;
  if (args) {
...
EntityTagger_createEntity_result.prototype = {};
EntityTagger_createEntity_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
EntityTagger_createEntity_result.prototype.write = function(output) {
  output.writeStructBegin('EntityTagger_createEntity_result');
...
EntityTagger_createTag_args = function(args) {
  this.tag = null;
  if (args) {
...
EntityTagger_createTag_args.prototype = {};
EntityTagger_createTag_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
EntityTagger_createTag_args.prototype.write = function(output) {
  output.writeStructBegin('EntityTagger_createTag_args');
...
EntityTagger_createTag_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
EntityTagger_createTag_result.prototype = {};
EntityTagger_createTag_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
EntityTagger_createTag_result.prototype.write = function(output) {
  output.writeStructBegin('EntityTagger_createTag_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.I32, 0);
    output.writeI32(this.success);
    output.writeFieldEnd();
...
EntityTagger_getEntity_args = function(args) {
  this.entityId = null;
  if (args) {
...
EntityTagger_getEntity_args.prototype = {};
EntityTagger_getEntity_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
EntityTagger_getEntity_args.prototype.write = function(output) {
  output.writeStructBegin('EntityTagger_getEntity_args');
...
EntityTagger_getEntity_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
EntityTagger_getEntity_result.prototype = {};
EntityTagger_getEntity_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
EntityTagger_getEntity_result.prototype.write = function(output) {
  output.writeStructBegin('EntityTagger_getEntity_result');
  if (this.success !== null && this.success !== undefined) {
...
EntityTagger_getTag_args = function(args) {
  this.tagId = null;
  if (args) {
...
EntityTagger_getTag_args.prototype = {};
EntityTagger_getTag_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
EntityTagger_getTag_args.prototype.write = function(output) {
  output.writeStructBegin('EntityTagger_getTag_args');
...
EntityTagger_getTag_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
EntityTagger_getTag_result.prototype = {};
EntityTagger_getTag_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
EntityTagger_getTag_result.prototype.write = function(output) {
  output.writeStructBegin('EntityTagger_getTag_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
EntityTagger_addEntityTag_args = function(args) {
  this.entityId = null;
  this.tagId = null;
  if (args) {
    if (args.entityId !== undefined) {
...
EntityTagger_addEntityTag_result = function(args) {
};
...
EntityTagger_removeEntityTag_args = function(args) {
  this.entityId = null;
  this.tagId = null;
  if (args) {
    if (args.entityId !== undefined) {
...
EntityTagger_removeEntityTag_result = function(args) {
};
...
EntityTagger_getEntityTags_args = function(args) {
  this.entityId = null;
  if (args) {
    if (args.entityId !== undefined) {
      this.entityId = args.entityId;
...
EntityTagger_getEntityTags_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
EntityTagger_getEntitiesByTagList_args = function(args) {
  this.tagIds = null;
  if (args) {
...
EntityTagger_getEntitiesByTagList_args.prototype.write = function(output) {
  ...
  if (this.tagIds !== null && this.tagIds !== undefined) {
    ...
    for (var iter23 in this.tagIds)
    {
      if (this.tagIds.hasOwnProperty(iter23))
      {
        iter23 = this.tagIds[iter23];
...
EntityTagger_getEntitiesByTagList_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
EntityTaggerClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
EntityTaggerClient.prototype.createEntity = function(entity, callback) {
...
EntityTaggerClient.prototype.send_createEntity = function(entity) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('createEntity', Thrift.MessageType.CALL, this.seqid());
  var args = new EntityTagger_createEntity_args();
  args.entity = entity;
  args.write(output);
...
EntityTaggerClient.prototype.recv_createEntity = function(input,mtype,rseqid) {
  ...
  var result = new EntityTagger_createEntity_result();
  result.read(input);
  input.readMessageEnd();
...
EntityTaggerClient.prototype.createTag = function(tag, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
EntityTaggerClient.prototype.send_createTag = function(tag) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('createTag', Thrift.MessageType.CALL, this.seqid());
  var args = new EntityTagger_createTag_args();
  args.tag = tag;
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
...
EntityTaggerClient.prototype.recv_createTag = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new EntityTagger_createTag_result();
  result.read(input);
  input.readMessageEnd();
...
EntityTaggerClient.prototype.getEntity = function(entityId, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
EntityTaggerClient.prototype.send_getEntity = function(entityId) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getEntity', Thrift.MessageType.CALL, this.seqid());
  var args = new EntityTagger_getEntity_args();
...
EntityTaggerClient.prototype.recv_getEntity = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new EntityTagger_getEntity_result();
  result.read(input);
  input.readMessageEnd();
...
EntityTaggerClient.prototype.getTag = function(tagId, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
EntityTaggerClient.prototype.send_getTag = function(tagId) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getTag', Thrift.MessageType.CALL, this.seqid());
  var args = new EntityTagger_getTag_args();
  args.tagId = tagId;
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
...
EntityTaggerClient.prototype.recv_getTag = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new EntityTagger_getTag_result();
  result.read(input);
  input.readMessageEnd();
...
EntityTaggerProcessor = exports.Processor = function(handler) {
...
EntityTaggerProcessor.prototype.process_createEntity = function(seqid, input, output) {
  var args = new EntityTagger_createEntity_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.createEntity.length === 1) {
    Q.fcall(this._handler.createEntity, args.entity)
      .then(function(result) {
        var result = new EntityTagger_createEntity_result({success: result});
        output.writeMessageBegin("createEntity", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new EntityTagger_createEntity_result(err);
        output.writeMessageBegin("createEntity", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.createEntity(args.entity,  function (err, result) {
      var result = new EntityTagger_createEntity_result((err != null ? err : {success: result}));
      output.writeMessageBegin("createEntity", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
EntityTaggerProcessor.prototype.process_createTag = function(seqid, input, output) {
  var args = new EntityTagger_createTag_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.createTag.length === 1) {
    Q.fcall(this._handler.createTag, args.tag)
      .then(function(result) {
        var result = new EntityTagger_createTag_result({success: result});
        output.writeMessageBegin("createTag", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new EntityTagger_createTag_result(err);
        output.writeMessageBegin("createTag", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.createTag(args.tag,  function (err, result) {
      var result = new EntityTagger_createTag_result((err != null ? err : {success: result}));
      output.writeMessageBegin("createTag", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
EntityTaggerProcessor.prototype.process_getEntity = function(seqid, input, output) {
  var args = new EntityTagger_getEntity_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getEntity.length === 1) {
    Q.fcall(this._handler.getEntity, args.entityId)
      .then(function(result) {
        var result = new EntityTagger_getEntity_result({success: result});
        output.writeMessageBegin("getEntity", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new EntityTagger_getEntity_result(err);
        output.writeMessageBegin("getEntity", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getEntity(args.entityId,  function (err, result) {
      var result = new EntityTagger_getEntity_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getEntity", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
EntityTaggerProcessor.prototype.process_getTag = function(seqid, input, output) {
  var args = new EntityTagger_getTag_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getTag.length === 1) {
    Q.fcall(this._handler.getTag, args.tagId)
      .then(function(result) {
        var result = new EntityTagger_getTag_result({success: result});
        output.writeMessageBegin("getTag", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new EntityTagger_getTag_result(err);
        output.writeMessageBegin("getTag", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getTag(args.tagId,  function (err, result) {
      var result = new EntityTagger_getTag_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getTag", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
