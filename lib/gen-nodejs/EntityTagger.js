...
var EntityTagger_addEntityTag_result = function(args) {
  ...
  if (args instanceof EntityService_ttypes.IncorrectEntity) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRUCT) {
        this.incorrectEntity = new EntityService_ttypes.IncorrectEntity();
...
EntityTagger_addEntityTag_result.prototype.write = function(output) {
  ...
  if (this.incorrectTag !== null && this.incorrectTag !== undefined) {
    output.writeFieldBegin('incorrectTag', Thrift.Type.STRUCT, 2);
